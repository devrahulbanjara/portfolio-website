...
function auditBlogPost(filePath) {
    ...
    if (!frontmatter.excerpt) {
        ...
        issues.push(`⚠️  Description too long (${frontmatter.excerpt.length}/${MAX_DESCRIPTION_LENGTH} chars)`);
    }
    ...
    if (!frontmatter.keywords || frontmatter.keywords.length === 0) {
        ...
        issues.push(`⚠️  Too many keywords (${frontmatter.keywords.length}/${MAX_KEYWORDS} maximum)`);
    }
