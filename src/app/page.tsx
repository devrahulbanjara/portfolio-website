        ...
        <div className="pb-24">
            ...
            <section className="max-w-[672px] mx-auto px-6 pt-8 sm:pt-20">
                ...
                <div className="mb-14">
                    <div className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-lg bg-muted/50 dark:bg-muted/40 border border-border/60">
                        <span className="text-[13px] text-muted-foreground">Currently working on</span>
                ...
                <div className="mb-14">
                    <h2 className="text-sm font-medium text-foreground uppercase tracking-wider mb-4">Skills</h2>
            ...
            <section className="max-w-[672px] mx-auto px-6 pb-8">
                <div className="pt-8 border-t border-border/60">
                    <Button variant="default" size="sm" className="rounded-full text-[13px] px-5" asChild>
